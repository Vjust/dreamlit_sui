      ...
      <main className="flex-grow flex items-center">
        ...
        <section className="bg-gradient-to-b from-indigo-50 to-white dark:from-gray-900 dark:to-black py-20 w-full">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            We're a dynamic crypto development team specializing in building cutting-edge <span className="font-semibold text-gray-900 dark:text-white">Web3 applications</span>. Our expertise spans both <span className="font-semibold text-gray-900 dark:text-white">fintech</span> and productivity solutions, with a strong focus on the <span className="font-semibold text-gray-900 dark:text-white">Sui ecosystem</span>. While Sui is our primary playground, our <span className="font-semibold text-gray-900 dark:text-white">software engineering</span> capabilities extend across <span className="font-semibold text-gray-900 dark:text-white">AI</span>, <span className="font-semibold text-gray-900 dark:text-white">crypto</span>, and <span className="font-semibold text-gray-900 dark:text-white">finance</span>. Get ready for our upcoming mobile app, designed to bring our innovative solutions right to your fingertips. We're passionate about creating the next generation of decentralized experiences.
            </p>
